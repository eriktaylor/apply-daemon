...
├── docs/                        # PROFILE.md, CHATOPS.md, MODELS.md, PROXY.md, EVAL_GUIDE.md, PROJECT_BRIEFING.md, AUDIT.md
...
| `docs/*.md` | reference | the deep version of one topic (profile authoring, models, chatops, proxy, audit, eval) |
