...
_ASSET_SCHEMAS = {
    "resume": [
        (
            '"executive_summary_rewrite": "<A tailored strategic, high-impact professional '
            'summary (3-5 sentences) to replace the executive summary at the top of the resume. '
            'Write for this specific role and company. '
            'CONSTRAINT: Use the candidate\'s actual industry and domain — DO NOT import '
            'domain-specific language, jargon, or context from the target role unless it already '
            'appears in the candidate\'s background. '
            'Vocabulary Swapping (replacing a word with a near-synonym that resonates with the '
            'target role) and Executive Framing (elevating scope, scale, and impact language) '
            'are encouraged. Domain Transmutation is strictly prohibited.>"'
        ),
        (
            '"resume_bullet_edits": [\n'
            ...
            '        ...\n'
            '    ]\n'
            '    CONSTRAINT — Maintain Original Domain Context: Never reframe a bullet as if '
            'the candidate worked in the target role\'s industry. The domain and employer context '
            'of each bullet must remain true to the candidate\'s actual experience.\n'
            '    STRATEGY — Vocabulary Swapping is OK: Replace a word with a near-synonym that '
            'resonates with the target role (e.g. "performance benchmarks" → '
            '"safety-critical performance benchmarks").\n'
            '    STRATEGY — Executive Framing is Preferred: Elevate the impact, scope, and scale '
            'of what the candidate actually did without changing the underlying industry or domain.\n'
            '    PROHIBITED — Domain Transmutation: Do NOT add clinical, robotics, or other '
            'target-domain framing to bullets that originate from a different industry '
            '(e.g., consumer electronics, SaaS, fintech). This causes hallucinations.\n'
